    ...
    return (
        <section className="min-h-screen flex flex-col md:flex-row items-center justify-between bg-[#4B0000] px-6 md:px-16 lg:px-24 py-28 relative overflow-visible">
            ...
            <div className="md:w-1/2 z-20 text-center md:text-left">
                <h1
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#FFF5E1] leading-tight drop-shadow-lg"
                    style={{ animation: "fadeInUp 1s ease forwards" }}
                >
                    The Taste You’ll Love
                </h1>
                <p
                    className="mt-4 sm:mt-6 text-lg sm:text-xl text-[#FFB89C] max-w-md mx-auto md:mx-0"
                ...
                >
                    ...
                    <Link
                        to="/about"
                        className="px-8 py-3 border-2 border-[#FFF5E1] text-[#FFF5E1] font-bold rounded-full hover:bg-[#FFF5E1] hover:text-[#4B0000] transition"
                    >
                        Learn More
                    </Link>
                </div>
            ...
            <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center md:justify-end relative">
                <div className="relative w-64 sm:w-80 md:w-[450px] lg:w-[500px]">
                    ...
                    <div
                        className="absolute -bottom-6 -right-6 w-24 h-24 rounded-full bg-[#FFF5E1]/30 blur-2xl z-0"
